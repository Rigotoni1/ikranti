...
select public.ir_save_onboarding('buyer','{"legal_name":"Test Buyer","phone":"+356 12345678","country":"Malta","address":"123 Test Street, Malta","terms_accepted":"true","terms_version":"2026-09-22","role":"admin","verified":true}',3,true);
...
do $$ begin
 begin perform public.ir_save_onboarding('seller','{"legal_name":"Test Seller","phone":"+356 12345678","country":"Malta","address":"123 Test Street, Malta","terms_accepted":"true","terms_version":"2026-09-22","business_name":"Business without evidence"}',3,true); raise exception 'FAIL: business seller without documents'; exception when raise_exception then if sqlerrm<>'Business registration and evidence required' then raise; end if; end;
end $$;
...
reset role;
set local role authenticated;
select public.ir_save_onboarding('seller','{"legal_name":"Test Seller","phone":"+356 12345678","country":"Malta","address":"123 Test Street, Malta","terms_accepted":"true","terms_version":"2026-09-22"}',3,true);
