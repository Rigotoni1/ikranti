...
select set_config('request.jwt.claims','{"sub":"40000000-0000-4000-8000-000000000001","aal":"aal1"}',true);
do $$ begin
 begin perform public.ir_bid('50000000-0000-4000-8000-000000000001',100,gen_random_uuid()); raise exception 'FAIL: self bid'; exception when raise_exception then if sqlerrm like 'FAIL:%' or sqlerrm<>'You cannot bid on your own auction' then raise; end if; end;
end $$;
select set_config('request.jwt.claims','{"sub":"40000000-0000-4000-8000-000000000002","aal":"aal1"}',true);
do $$ begin
 begin perform public.ir_bid('50000000-0000-4000-8000-000000000001',100,gen_random_uuid()); raise exception 'FAIL: linked bid'; exception when raise_exception then if sqlerrm like 'FAIL:%' or sqlerrm<>'Linked seller accounts cannot bid' then raise; end if; end;
...
select set_config('request.jwt.claims','{"sub":"40000000-0000-4000-8000-000000000003","aal":"aal1"}',true);
do $$ begin
 begin perform public.ir_bid('50000000-0000-4000-8000-000000000001',100,gen_random_uuid()); raise exception 'FAIL: no identity verification'; exception when raise_exception then if sqlerrm like 'FAIL:%' or sqlerrm<>'Identity verification required before bidding' then raise; end if; end;
end $$;
reset role;
...
set local role authenticated;
do $$ begin
 begin perform public.ir_bid('50000000-0000-4000-8000-000000000001',100,gen_random_uuid()); raise exception 'FAIL: trading gate bypass'; exception when raise_exception then if sqlerrm like 'FAIL:%' or sqlerrm<>'Trading is not open yet' then raise; end if; end;
end $$;
reset role;
