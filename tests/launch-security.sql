...
select public.ir_bid('20000000-0000-4000-8000-000000000001',200,'30000000-0000-4000-8000-000000000001');
select public.ir_bid('20000000-0000-4000-8000-000000000001',200,'30000000-0000-4000-8000-000000000001');
...
do $$ begin
 begin perform public.ir_bid('20000000-0000-4000-8000-000000000001',225,'30000000-0000-4000-8000-000000000001'); raise exception 'FAIL: reused request accepted'; exception when raise_exception then if sqlerrm like 'FAIL:%' then raise; end if; if sqlerrm<>'Request ID already used' then raise; end if; end;
end $$;
select set_config('request.jwt.claims','{"sub":"10000000-0000-4000-8000-000000000003","aal":"aal1"}',true);
...
select public.ir_bid('20000000-0000-4000-8000-000000000001',200,'30000000-0000-4000-8000-000000000002');
...
select set_config('request.jwt.claims','{"sub":"10000000-0000-4000-8000-000000000004","aal":"aal1"}',true);
...
select set_config('request.jwt.claims','{"sub":"10000000-0000-4000-8000-000000000004","aal":"aal2"}',true);
...
select set_config('request.jwt.claims','{"sub":"10000000-0000-4000-8000-000000000003","aal":"aal1"}',true);
do $$ begin
 begin perform public.ir_bid('20000000-0000-4000-8000-000000000001',300,gen_random_uuid()); raise exception 'FAIL: suspended account bid'; exception when raise_exception then if sqlerrm like 'FAIL:%' or sqlerrm<>'Verified, active account required' then raise; end if; end;
end $$;
